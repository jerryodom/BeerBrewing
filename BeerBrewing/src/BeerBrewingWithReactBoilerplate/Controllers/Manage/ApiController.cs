...
using BeerBrewingWithReactBoilerplate.Controllers.Manage.Models;
using BeerBrewingWithReactBoilerplate.Models;
using BeerBrewingWithReactBoilerplate.Services;
using BeerBrewingWithReactBoilerplate.State;
using BeerBrewingWithReactBoilerplate.State.Manage;

namespace BeerBrewingWithReactBoilerplate.Controllers.Manage
{
    [Authorize]
    [Route("api/manage")]

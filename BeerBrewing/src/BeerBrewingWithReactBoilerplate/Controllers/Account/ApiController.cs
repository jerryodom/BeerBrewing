...
using BeerBrewingWithReactBoilerplate.Controllers.Account.Models;
using BeerBrewingWithReactBoilerplate.Models;
using BeerBrewingWithReactBoilerplate.Services;

namespace BeerBrewingWithReactBoilerplate.Controllers.Account
{
    [Route("api/account")]
        ...
        public async Task<object> Register([FromBody]RegisterModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        success = true,
                        user = BeerBrewingWithReactBoilerplate.Models.Api.User.From(user)
                    };
                }
